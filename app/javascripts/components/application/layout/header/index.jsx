...
import BountySapphireLogoImage from '@/../images/logos/bountysapphire-logo-white.png'
        ...
        <div className="container">
          <div className="navbar-brand">
            <div className="navbar-item">
              <NavLink to="/">
                <img src={`/${BountySapphireLogoImage}`} />
              </NavLink>
            </div>
          ...
          <div
            ...
            <div className="navbar-start">
              <div className="navbar-item">
                <NavLink to="/bounties/new" activeClassName="is-active"  className="button is-info">
                  <span>Create Bounty</span>
                </NavLink>
              </div>
              <div className='navbar-item'>
                <NavLink to="/bounties/all" activeClassName="is-active">
                  <span>All Bounties</span>
                </NavLink>
              </div>
              <div className="navbar-item">
                <NavLink to="/bounties/mine" activeClassName="is-active">
                  <span>My List of Bounties</span>
                </NavLink>
              </div>
            </div>
          </div>
